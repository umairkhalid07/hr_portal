...
Position.create(
  name: 'UX/UX Designer',
  description: 'We are looking for UX/UI Game Designer to help us build the interfaces and user flows to our games. Our game experiences combine casual games, board games, narrative and physical elements (that may or may not include fx like bloom, fire and confettis… really!).',
  deadline: '2022-11-25 00:00:00',
  available: 2
)
Candidate.create(
